        ...
        >
          <div className="flex items-center justify-between gap-8">
            <Link
              ...
              className={`font-mono text-[0.7rem] font-medium uppercase transition-colors ${
                isHomeActive
                  ? "text-red-300"
              ...
              {navItems.map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={`font-mono text-[0.7rem] font-normal transition-colors ${
                      isActive
                        ? "text-red-300"
        ...
        >
          ...
          >
            <div className="flex items-center justify-between border-b border-white/10 px-5 py-5">
              <p className="font-mono text-[0.7rem] font-medium uppercase text-zinc-100">
                Navigation
              </p>
              <button
                type="button"
              ...
              {navItems.map((item) => {
                ...
                return (
                  <Link
                    ...
                    href={item.href}
                    aria-current={isActive ? "page" : undefined}
                    className={`rounded-md px-3 py-3 font-mono text-sm font-normal transition-colors ${
                      isActive
